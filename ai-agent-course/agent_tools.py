...
model = AutoModelForSeq2SeqLM.from_pretrained(MODEL_ID).to("cpu")  # CPU

def llm_generate(prompt: str, max_new_tokens: int, do_sample: bool = False) -> str:
...
def web_search(query: str) -> str:
    ...
    out = llm_generate(prompt, max_new_tokens=40).strip()
