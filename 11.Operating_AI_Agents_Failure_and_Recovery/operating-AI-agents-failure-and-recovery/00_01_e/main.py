"""
Course 2 — Lesson 1: Trigger a Bad Agent Action
...
async def main() -> None:
    ...
    # NOTE: Shopping summary produced in first course Governing AI Agents: Visibility and Control
    # https://www.linkedin.com/learning/governing-ai-agents-visibility-and-control
    prompt = (
