"""
Course 2 — Lesson 2: Detect Agent Failures
...
Usage:
  python scanner.py 
    --output 00_02_b/out/shopping_summary.json 
    --log 00_02_b/logs/agent_events.jsonl
...
def scan_for_sensitive(text: str) -> List[Dict[str, str]]:
    ...
    #TODO: Loop through the text and look for anything that matches the CARD_LAST4_RE regex.
    #      Add every match to the findings list. 
    #      Capture three things:
    #      1. The type of issue we detected, labeled as card_last4
    #      2. The exact text that triggered the match, like “ending in 4821”
    #      3. The actual four digits that were extracted, stored separately as value
...
def main() -> None:
    ...
    #TODO: scan for sensitive text and store in findings
